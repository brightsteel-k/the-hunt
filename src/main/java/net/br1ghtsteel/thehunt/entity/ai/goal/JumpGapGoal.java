...
public class JumpGapGoal extends Goal {
    private final MobEntity mob;
    private LivingEntity target;
    private final float jumpVelocity;

    public JumpGapGoal(MobEntity mob, float jumpVelocity) {
        this.mob = mob;
    ...
    public void start() {
        ...
        this.mob.setVelocity(vec3d2.x, (double)this.jumpVelocity, vec3d2.z);
    }
}
